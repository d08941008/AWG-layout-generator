...
if onlyParam == 0:
    ...
    # right input lens, FC
    idxSeg = writeLens(idxSeg, 'Ririb', '-Rorib', 'Lstarrib', 'Zlensrib', '0', 2, 'Wstarrib', draw_priority = -4, mask_layer = 3505, color = 7)

    # right input lens, floor
    idxSeg = writeLens(idxSeg, 'Riflr', '-Roflr', 'Lstarflr', 'Zlensflr', '0', 2, 'Wstarflr', draw_priority = -5, mask_layer = 3705, color = 6)

    # input port taper
    idxSegList0 = []
    for i in range(Nin):
        idxSeg = writeSegment(idxSeg, begin_x = '(Ro-Lim)*sin(180-(180-zAi' + str2(i+1) + ')/2) rel end segment 2', 
        ...
        idxSeg = writeSegment(idxSeg, begin_x = '(Ro+Lit)*sin(180-(180-zAi' + str2(i+1) + ')/2) rel end segment 2', 
        ...
        # input port straight
        idxSeg = writeSegment(idxSeg, begin_x = '(Ro+Litm)*sin(180-(180-zAi' + str2(i+1) + ')/2) rel end segment 2', 
    ...
    # left lens, FC
    idxSeg = writeLens(idxSeg, 'Ririb', '-Rorib', 'Lstarrib', 'Zlensrib', '(1-outputSign)*90', idxSeg-1, 'Wstarrib', draw_priority = -4, mask_layer = 3505, color = 7)

    # left lens, floor
    idxSeg = writeLens(idxSeg, 'Riflr', '-Roflr', 'Lstarflr', 'Zlensflr', '(1-outputSign)*90', idxSeg-2, 'Wstarflr', draw_priority = -5, mask_layer = 3705, color = 6)
